package com.example.AirlineManagementSystem.persistance;
...
public class CarrierPO {
    ...
    @Column(name = "thirty_Days_Advance_Booking")
    private int thirtyDaysAdvanceBooking;

    @Column(name = "sixty_Days_Advance_Booking")
    private int sixtyDaysAdvanceBooking;

    @Column(name = "ninety_Days_Advance_Booking")
    private int ninetyDaysAdvanceBooking;

    @Column(name = "bulk_Booking")
    private int bulkBooking;

    @Column(name = "silver_User")
    private int silverUser;

    @Column(name = "gold_User")
    private int goldUser;

    @Column(name = "platinum_User")
    private int platinumUser;

    @Column(name = "two_Days_Before_Travel_Date")
    private int twoDaysBeforeTravelDate;

    @Column(name = "ten_Days_Before_Travel_Date")
    private int tenDaysBeforeTravelDate;

    @Column(name = "twenty_Days_Before_Travel_Date")
    ...
    public CarrierPO(int carrierId, String carrierName, int thirtyDaysAdvanceBooking, int sixtyDaysAdvanceBooking, 
    ...
    public String toString() {
        return "CarrierPO [carrierId=" + carrierId + ", carrierName=" + carrierName + 
